  ...
  apps: [
    {
      ...
      env_development: {
        ...
        READY_UP_ALLOWED_ORIGINS: [
          "https://ready-up.test:8080",
          "https://ready-up.test:8000",
        ].join(","),
        READY_UP_LISTEN_ADDRESS: "0.0.0.0",
        READY_UP_LISTEN_PORT: 3030,
        READY_UP_PG_CONNECTION_STRING:
          "postgresql://postgres@localhost/ready-up",
        READY_UP_SESSION_SECRET_KEY_PATH:
          "/home/andrew/tmp/ready-up-session-secret-key",
